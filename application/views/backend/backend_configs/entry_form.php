	...
	<div class="card-body">
        <div class="row">
          	<div class="col-md-6">
				...
				<div class="form-group">
						<label><?php echo get_msg('topics_fe_label')?>
							<a href="#" class="tooltip-ps" data-toggle="tooltip" title="<?php echo get_msg('topics_fe_label')?>">
								<span class='glyphicon glyphicon-info-sign menu-icon'>
							</a>
						</label>
						<?php 
							echo form_input( array(
								...
								'id' => 'topics_fe',
								'class' => 'form-control',
								'placeholder' => get_msg('topics_fe_label'),
								'value' => set_value( 'topics_fe', show_data( @$backend->topics_fe ), false )
							));
						?>
					</div>
          	...
          	<div class="col-md-6">
				...
				<div class="form-group">
					<label><?php echo get_msg('app_token_label')?>
						<a href="#" class="tooltip-ps" data-toggle="tooltip" title="<?php echo get_msg('app_token_label')?>">
							<span class='glyphicon glyphicon-info-sign menu-icon'>
						</a>
					</label>
					<?php 
						echo form_input( array(
							...
							'id' => 'app_token',
							'class' => 'form-control',
							'placeholder' => get_msg('app_token_label'),
							'value' => set_value( 'app_token', show_data( @$backend->app_token ), false )
						));
					?>
				</div>
          	</div>
                ...
                <div class="form-group" style="padding-top: 30px;">
                    <div class="form-check">
                        ...
                        <label class="form-check-label">
                            ...
                            <label><?php echo get_msg( 'user_social_info_override' ); ?></label>
                        </label>
                    </div>
                </div>
            ...
            <legend class="ml-3"><?php echo get_msg('img_configuration')?></legend>
		        <hr width="100%">
		        <div class="col-md-6">
		        	<h5><?php echo get_msg('org_img_size'); ?></h5>
		        	<div class="form-group">
