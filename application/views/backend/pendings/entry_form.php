      ...
      <div class="card-body">
      	<div class="row">
            ...
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'title',
                'value' => set_value( 'title', show_data( @$pending->title), false ),
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'manufacturer_id',
                  $options,
                  set_value( 'manufacturer_id', show_data( @$pending->manufacturer_id), false ),
            ...
            <div class="form-group">
              ...
              <?php
                if(isset($pending)) {
                  ...
                  $conds['manufacturer_id'] = $pending->manufacturer_id;
                  ...
                  echo form_dropdown(
                    'model_id',
                    $options,
                    set_value( 'model_id', show_data( @$pending->model_id), false ),
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'item_type_id',
                  $options,
                  set_value( 'item_type_id', show_data( @$pending->item_type_id), false ),
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'item_location_id',
                  $options,
                  set_value( 'item_location_id', show_data( @$pending->item_location_id), false ),
            ...
            <div class="form-group">
              ...
              <?php
                if(isset($pending)) {
                  ...
                  $conds['city_id'] = $pending->item_location_id;
                  ...
                  echo form_dropdown(
                    ...
                    $options,
                    set_value( 'item_location_township_id', show_data( @$pending->item_location_township_id), false ),
            ...
            <div class="form-group">
              ...
              <?php echo form_textarea( array(
                'name' => 'description',
                'value' => set_value( 'description', show_data( @$pending->description), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              ...
              <?php echo form_textarea( array(
                'name' => 'highlight_info',
                'value' => set_value( 'info', show_data( @$pending->highlight_info), false ),
                'class' => 'form-control form-control-sm',
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'price',
                'value' => set_value( 'price', show_data( @$pending->price), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'item_price_type_id',
                  $options,
                  set_value( 'item_price_type_id', show_data( @$pending->item_price_type_id), false ),
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'item_currency_id',
                  $options,
                  set_value( 'item_currency_id', show_data( @$pending->item_currency_id), false ),
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  ...
                  $options,
                  set_value( 'condition_of_item_id', show_data( @$pending->condition_of_item_id), false ),
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'brand',
                'value' => set_value( 'brand', show_data( @$pending->brand), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              <label>
                <?php echo get_msg('owner_of_item') ." : ".$this->User->get_one( $pending->added_user_id )->user_name; ?>
              </label>
            </div>
          </div>
            ...
            <div class="form-group">
              <div class="form-check">
                ...
                <?php echo form_checkbox( array(
                  ...
                  'id' => 'business_mode',
                  'value' => 'accept',
                  'checked' => set_checkbox('business_mode', 1, ( @$pending->business_mode == 1 )? true: false ),
            ...
            <div class="form-group">
              <div class="form-check">
                ...
                <?php echo form_checkbox( array(
                  ...
                  'id' => 'is_sold_out',
                  'value' => 'accept',
                  'checked' => set_checkbox('is_sold_out', 1, ( @$pending->is_sold_out == 1 )? true: false ),
                  'class' => 'form-check-input',
                  'onclick' => 'return false'
                )); ?>
            ...
            <div class="form-group">
              ...
              <?php 
                echo form_input( array(
                  ...
                  'class' => 'form-control',
                  'placeholder' => '',
                  'value' =>  set_value( 'lat', show_data( @$pending->lng ), false ),
                  'readonly' => 'true'
                ));
              ?>
            </div>
