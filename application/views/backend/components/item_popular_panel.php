...
<?php if ( ! empty( $data )): ?>
  <div class="row">
    ...
    <div class="col-md-6">
      <ul class="chart-legend clearfix">
        ...
        <li><i class="fa fa-circle-o <?php echo $circle_color[$i]; ?>"></i><?php echo $d->title; ?>(<?php echo $d->t_count; ?> touches )</li>
        <?php endforeach; ?>
      </ul>
    </div>
  ...
  <!-- /.row -->
  <?php else: ?>
    <div class="h-100 row"><h5 class="m-auto"><?php echo get_msg('no_items'); ?></h5></div>
  <?php endif; ?>
</div>
<!-- /.card-body -->
...
<?php 
    ...
    if ($permission_data_count > 0) {
      ...
      //get module id
      $conds_moudle['module_name'] = "popularitems";
      ...
      if ($allowed_module_data->is_empty_object == 0) { ?>
        ...
        <div class="card-footer text-center">
          <a href="<?php echo site_url('admin/popularitems'); ?>"><?php echo get_msg('view_all_label'); ?></a>
        </div>
        <!-- /.card-footer -->
      <?php } ?>
    <?php } else { ?>  
