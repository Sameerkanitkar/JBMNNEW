<div class="table-responsive animated fadeInRight">
	<table class="table m-0 table-striped">
		<tr>
			...
			<th><?php echo get_msg('app_purchase_product_id_label'); ?> </th>
			<th><?php echo get_msg('item_description_label'); ?></th>
			<th><?php echo get_msg('day_label'); ?></th>
			<th><?php echo get_msg('purchase_type_label'); ?></th>
	...
	<?php if ( !empty( $in_app_purchases ) && count( $in_app_purchases->result()) > 0 ): ?>
		...
		<?php foreach($in_app_purchases->result() as $in_app_purchase): ?>
			...
			<tr>
				...
				<td><?php echo  $this->In_app_purchase->get_one( $in_app_purchase->id )->type;?>
				</td>
