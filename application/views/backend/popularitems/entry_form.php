    ...
    <form role="form">
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'manufacturer_id',
                  $options,
                  set_value( 'manufacturer_id', show_data( @$popularitem->manufacturer_id), false ),
              ...
              <?php
                if(isset($item)) {
                  ...
                  echo form_dropdown(
                    'model_id',
                    $options,
                    set_value( 'model_id', show_data( @$popularitem->model_id), false ),
            ...
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'price',
                'value' => set_value( 'price', show_data( @$popularitem->price), false ),
            ...
            <div class="form-group">
              ...
              <?php echo form_textarea( array(
                'name' => 'description',
                'value' => set_value( 'description', show_data( @$popularitem->description), false ),
                'class' => 'form-control form-control-sm',
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'plat_number',
                'value' => set_value( 'plat_number', show_data( @$popularitem->plat_number), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'engine_power',
                'value' => set_value( 'engine_power', show_data( @$popularitem->engine_power), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'year',
                'value' => set_value( 'year', show_data( @$popularitem->year), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'seller_type_id',
                  $options,
                  set_value( 'seller_type_id', show_data( @$popularitem->seller_type_id), false ),
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'title',
                'value' => set_value( 'title', show_data( @$popularitem->title), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              ...
              <?php echo form_textarea( array(
                'name' => 'highlight_info',
                'value' => set_value( 'info', show_data( @$popularitem->highlight_info), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'no_of_owner',
                'value' => set_value( 'no_of_owner', show_data( @$popularitem->no_of_owner), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'trim_name',
                'value' => set_value( 'trim_name', show_data( @$popularitem->trim_name), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'item_type_id',
                  $options,
                  set_value( 'item_type_id', show_data( @$popularitem->item_type_id), false ),
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'item_location_id',
                  $options,
                  set_value( 'item_location_id', show_data( @$popularitem->item_location_id), false ),
            ...
            <div class="form-group">
              ...
              <?php
                if(isset($popularitem)) {
                  ...
                  $conds['city_id'] = $popularitem->item_location_id;
                  ...
                  echo form_dropdown(
                    ...
                    $options,
                    set_value( 'item_location_township_id', show_data( @$popularitem->item_location_township_id), false ),
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  ...
                  $options,
                  set_value( 'condition_of_item_id', show_data( @$popularitem->condition_of_item_id), false ),
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'build_type_id',
                  $options,
                  set_value( 'build_type_id', show_data( @$popularitem->build_type_id), false ),
            ...
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'no_of_doors',
                'value' => set_value( 'no_of_doors', show_data( @$popularitem->no_of_doors), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'max_passengers',
                'value' => set_value( 'max_passengers', show_data( @$popularitem->max_passengers), false ),
                'class' => 'form-control form-control-sm',
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'color_id',
                  $options,
                  set_value( 'color_id', show_data( @$popularitem->color_id), false ),
            ...
            <div class="form-group">
              ...
              <?php echo form_input( array(
                ...
                'value' => set_value( 'steering_position', show_data( @$popularitem->steering_position), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'fuel_type_id',
                  $options,
                  set_value( 'fuel_type_id', show_data( @$popularitem->fuel_type_id), false ),
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'mileage',
                'value' => set_value( 'mileage', show_data( @$popularitem->mileage), false ),
                'class' => 'form-control form-control-sm',
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'item_price_type_id',
                  $options,
                  set_value( 'item_price_type_id', show_data( @$popularitem->item_price_type_id), false ),
            ...
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'price_unit',
                'value' => set_value( 'price_unit', show_data( @$popularitem->price_unit), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'item_currency_id',
                  $options,
                  set_value( 'item_currency_id', show_data( @$popularitem->item_currency_id), false ),
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'vehicle_id',
                'value' => set_value( 'vehicle_id', show_data( @$popularitem->vehicle_id), false ),
                'class' => 'form-control form-control-sm',
              ...
              <div class="input-group">
                <div class="input-group-prepend">
                 ...
                 <?php echo form_input(array(
                        ...
                        'value' => set_value( 'license_expiration_date',  show_data( @$popularitem->license_expiration_date), false ),
                        'class' => 'form-control',
                        'placeholder' => '',
            ...
            <div class="form-group">
              <div class="form-check">
                ...
                <?php echo form_checkbox( array(
                  ...
                  'id' => 'licence_status',
                  'value' => 'accept',
                  'checked' => set_checkbox('licence_status', 1, ( @$popularitem->licence_status == 1 )? true: false ),
            ...
            <div class="form-group">
              <div class="form-check">
                ...
                <?php echo form_checkbox( array(
                  ...
                  'id' => 'is_sold_out',
                  'value' => 'accept',
                  'checked' => set_checkbox('is_sold_out', 1, ( @$popularitem->is_sold_out == 1 )? true: false ),
                  'class' => 'form-check-input',
                  'readonly' => 'true'
                )); ?>
            ...
            <div class="form-group">
              <div class="form-check">
                ...
                <?php echo form_checkbox( array(
                  ...
                  'id' => 'business_mode',
                  'value' => 'accept',
                  'checked' => set_checkbox('business_mode', 1, ( @$popularitem->business_mode == 1 )? true: false ),
                  'class' => 'form-check-input',
                  'readonly' => 'true'
                )); ?>
        ...
        <div class="gallery" id="gallery" style="margin-left: 15px; margin-bottom: 15px;">
          <?php
              $conds = array( 'img_type' => 'item', 'img_parent_id' => $popularitem->id );
