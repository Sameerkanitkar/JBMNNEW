      ...
      <div class="card-body">
        <div class="row">
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'manufacturer_id',
                  $options,
                  set_value( 'manufacturer_id', show_data( @$reject->manufacturer_id), false ),
            ...
            <div class="form-group">
              ...
              <?php
                if(isset($reject)) {
                  ...
                  $conds['manufacturer_id'] = $reject->manufacturer_id;
                  ...
                  echo form_dropdown(
                    'model_id',
                    $options,
                    set_value( 'model_id', show_data( @$reject->model_id), false ),
            ...
            <div class="form-group">
              ...
              <?php
                if(isset($reject)) {
                  ...
                  $conds['city_id'] = $reject->item_location_id;
                  ...
                  echo form_dropdown(
                    ...
                    $options,
                    set_value( 'item_location_township_id', show_data( @$reject->item_location_township_id), false ),
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              <label>
                <?php echo get_msg('owner_of_item') ." : ".$this->User->get_one( $reject->added_user_id )->user_name; ?>
              </label>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div id="reject_map" style="width: 100%; height: 400px;"></div>
            ...
            <div class="form-group">
              ...
              <?php 
                echo form_input( array(
                  ...
                  'class' => 'form-control',
                  'placeholder' => '',
                  'value' => set_value( 'lat', show_data( @$reject->lat ), false ),
                  'readonly' => 'true'
                ));
              ?>
            </div>
