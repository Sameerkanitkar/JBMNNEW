              ...
              <div class="form-group">
                ...
                <?php
                  ...
                  echo form_dropdown(
                    ...
                    'class="form-control form-control-sm mr-3" '.$disabled.' id="manufacturer_id"'
                  );
                ?>
              </div>
                ...
                <?php
                  if(isset($item)) {
                    ...
                    echo form_dropdown(
                      ...
                      'class="form-control form-control-sm mr-3" '.$disabled.' id="model_id"'
                    );
              ...
              <div class="form-group">
                ...
                <?php
                  ...
                  echo form_dropdown(
                    ...
                    'class="form-control form-control-sm mr-3" '.$disabled.' id="transmission_id"'
                  );
                ?>
              </div>
              ...
              <div class="form-group">
                ...
                <?php
                  ...
                  echo form_dropdown(
                    ...
                    'class="form-control form-control-sm mr-3" '.$disabled.' id="seller_type_id"'
                  );
                ?>
              </div>
              ...
              <div class="form-group">
                ...
                <?php
                  ...
                  echo form_dropdown(
                    ...
                    'class="form-control form-control-sm mr-3" '.$disabled.' id="item_type_id"'
                  );
                ?>
              </div>
              ...
              <div class="form-group">
                ...
                <?php
                  ...
                  echo form_dropdown(
                    ...
                    'class="form-control form-control-sm mr-3" '.$disabled.' id="item_location_id"'
                  );
                ?>
              </div>
                ...
                <?php
                  if(isset($item)) {
                    ...
                    echo form_dropdown(
                      ...
                      'class="form-control form-control-sm mr-3" '.$disabled.' id="item_location_township_id"'
                    );
              ...
              <div class="form-group">
                ...
                <?php
                  ...
                  echo form_dropdown(
                    ...
                    'class="form-control form-control-sm mr-3" '.$disabled.' id="condition_of_item_id"'
                  );
                ?>
              </div>
              ...
              <div class="form-group">
                ...
                <?php
                  ...
                  echo form_dropdown(
                    ...
                    'class="form-control form-control-sm mr-3" '.$disabled.' id="build_type_id"'
                  );
                ?>
              </div>
              ...
              <div class="form-group">
                ...
                <?php
                  ...
                  echo form_dropdown(
                    ...
                    'class="form-control form-control-sm mr-3" '.$disabled.' id="color_id"'
                  );
                ?>
              </div>
              ...
              <div class="form-group">
                ...
                <?php
                  ...
                  echo form_dropdown(
                    ...
                    'class="form-control form-control-sm mr-3" '.$disabled.' id="fuel_type_id"'
                  );
                ?>
              </div>
              ...
              <div class="form-group">
                ...
                <?php
                  ...
                  echo form_dropdown(
                    ...
                    'class="form-control form-control-sm mr-3" '.$disabled.' id="item_price_type_id"'
                  );
                ?>
              </div>
                ...
                <label>
                  ...
                  <?php
                    ...
                    echo form_dropdown(
                      ...
                      'class="form-control form-control-sm mr-3" '.$disabled.' id="item_currency_id"'
                    );
                  ?>
              </div>
            </div>
