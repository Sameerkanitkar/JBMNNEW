	...
	<div class="card card-info">
		...
		<div class="card-body">
	        	...
	        	<legend class="ml-3"><?php echo get_msg('paid_currrency_setting')?></legend>
	          	<div class="col-md-6">
	          		<div class="form-group">
						<label><?php echo get_msg('currency_symbol')?>
							<a href="#" class="tooltip-ps" data-toggle="tooltip" title="<?php echo get_msg('currency_symbol')?>">
	        ...
	        <div class="col-md-6">
				...
				<?php echo $this->config->item("is_demo") == 1 ? 'disabled':''; ?>
				>
	        ...
	        <hr width="100%" size="8">
	        <legend class="ml-3"><?php echo get_msg('in_app_purchased_setting')?></legend>
                <a href="<?php echo site_url('admin/in_app_purchases'); ?>"><?php echo get_msg('purchase_key_label'); ?></a><br><br>
	       		...
	       		<div class="form-group">
					<div class="form-check">
						...
						if($this->config->item("is_demo") == 1 ){
							echo form_checkbox( array(
								'name' => 'in_app_purchased_enabled',
								'id' => 'in_app_purchased_enabled',
								'value' => 'accept',
								'disabled' => 'disabled',
								'checked' => set_checkbox('in_app_purchased_enabled', 1, ( @$pconfig->in_app_purchased_enabled == 1 )? true: false ),
								'class' => 'form-check-input'
							));	
						}else{
							echo form_checkbox( array(
						...
						<?php echo get_msg( 'purchase_enabled_label' ); ?>
	    ...
	    <div class="card-footer">
            <button type="submit" class="btn btn-sm btn-primary" <?php echo $this->config->item("is_demo") == 1 ? 'disabled':''; ?> >
				<?php echo get_msg('btn_save')?>
			</button>

			<a href="<?php echo $module_site_url; ?>" class="btn btn-sm btn-primary <?php echo $this->config->item("is_demo") == 1 ? 'disabled':''; ?>">
