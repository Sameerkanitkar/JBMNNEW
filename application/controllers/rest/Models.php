 ...
 * REST API for News
 */
class Models extends API_Controller
{
	...
	function default_conds()
	{
		...
		// if is get record using GET method
			...
			// get default setting for GET_ALL_MODELS
			$setting = $this->Api->get_one_by( array( 'api_constant' => GET_ALL_MODELS ));
	...
	function convert_object( &$obj )
	{
		...
		$this->ps_adapter->convert_models( $obj );
	}
